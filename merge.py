...
old = json.load(open("jan2020_to_14-10-21.json", encoding="utf8"))
current = json.load(open("oct_15.json", encoding="utf8"))[0]['items']
...
with open('jan2020_to_15-10-21.json', 'w') as f:
