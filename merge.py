...
old = json.load(open("jan2020_to_9-10-21.json", encoding="utf8"))
current = json.load(open("oct_10.json", encoding="utf8"))[0]['items']
...
with open('jan2020_to_10-10-21.json', 'w') as f:
