...
old = json.load(open("jan2020_to_10-10-21.json", encoding="utf8"))
current = json.load(open("oct_11.json", encoding="utf8"))[0]['items']
...
with open('jan2020_to_11-10-21.json', 'w') as f:
