...
old = json.load(open("jan2020_to_15-10-21.json", encoding="utf8"))
current = json.load(open("oct_16.json", encoding="utf8"))[0]['items']
...
with open('jan2020_to_16-10-21.json', 'w') as f:
