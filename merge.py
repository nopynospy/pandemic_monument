...
old = json.load(open("jan2020_to_16-10-21.json", encoding="utf8"))
current = json.load(open("oct_17.json", encoding="utf8"))[0]['items']
...
with open('jan2020_to_17-10-21.json', 'w') as f:
