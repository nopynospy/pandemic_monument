...
old = json.load(open("jan2020_to_8-10-21.json", encoding="utf8"))
current = json.load(open("oct_9.json", encoding="utf8"))[0]['items']
...
with open('jan2020_to_9-10-21.json', 'w') as f:
